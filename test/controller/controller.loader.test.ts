...
import { Controller, Data, IController, IHttpError, Middleware, MinLength, Post } from "../../src";
...
class SampleController extends IController {
    ...
    @Post public "/smth/:id/:name"(id: string, name: string, anything: number, dto: SampleControllerDto) {
